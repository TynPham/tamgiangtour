...
export interface FloatingZaloButtonProps
  extends React.AnchorHTMLAttributes<HTMLAnchorElement> {
  href?: string;
  ariaLabel?: string;
  onContactClick?: (payload: ContactClickedPayload) => void;
  className?: string;
}

export function ZaloIcon({ className = "size-6" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 50 50"
      fill="none"
  ...
  return (
    <a
      ...
      className={cn(
        ...
        "flex size-12 sm:size-14 items-center justify-center rounded-full bg-transparent",
        "transition-transform duration-150 ease-out",
        "hover:scale-105 active:scale-95",
        "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0068FF] focus-visible:ring-offset-2 focus-visible:ring-offset-background",
      ...
      {...props}
    >
      <ZaloIcon className="size-11 sm:size-12 drop-shadow-sm" />
